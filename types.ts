...
export type Page = 'Home' | 'Ask SkillLift' | 'Opportunities' | 'SkillQuest' | 'Resume Tips' | 'Community Forum' | 'Settings' | 'Wellbeing Hub' | 'Life Balance';
...
export interface InspirationalPerson {
    ...
    name: string;
    field: string;
    category: 'Historical Pioneers' | 'Modern Innovators' | 'Nobel Laureates' | 'Rising Stars';
    bio: string;
    quote: string;
